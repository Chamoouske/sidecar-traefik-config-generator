...
const file_internal_api_sidecar_proto_rawDesc = "" +
	"\n" +
	"\x1ainternal/api/sidecar.proto\x12\asidecar\"\xc1\x01\n" +
	"\n" +
	"AgentToHub\x12B\n" +
	...
	"\n" +
	"route_sync\x18\x03 \x01(\v2\x19.sidecar.RouteSyncRequestH\x00R\trouteSyncB\t\n" +
	"\apayload\"\xd9\x01\n" +
	"\n" +
	"HubToAgent\x12E\n" +
	...
	"\x1bauthoritative_service_names\x18\x01 \x03(\tR\x19authoritativeServiceNames2I\n" +
...
var file_internal_api_sidecar_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_internal_api_sidecar_proto_depIdxs = []int32{
	...
	4, // 3: sidecar.HubToAgent.connect_response:type_name -> sidecar.ConnectResponse
	5, // 4: sidecar.HubToAgent.route_command:type_name -> sidecar.RouteCommand
	8, // 5: sidecar.HubToAgent.route_sync:type_name -> sidecar.RouteSyncResponse
	0, // 6: sidecar.RouteCommand.action:type_name -> sidecar.RouteCommand.Action
	1, // 7: sidecar.SidecarService.Connect:input_type -> sidecar.AgentToHub
	2, // 8: sidecar.SidecarService.Connect:output_type -> sidecar.HubToAgent
